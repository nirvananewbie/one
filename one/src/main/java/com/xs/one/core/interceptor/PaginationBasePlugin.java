...
import com.xs.one.core.persistence.PageCondition;
import com.xs.one.core.persistence.PageHolder;
...
public abstract class PaginationBasePlugin implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (rowBounds.getLimit() == RowBounds.NO_ROW_LIMIT) {
            ...
            page = new PageBck(rowBounds.getOffset(), rowBounds.getLimit());
        }
     ...
     * @return 分页处理后的sql
     */
    protected abstract String paginationSql(String sql, PageBck page); // 子类实现
