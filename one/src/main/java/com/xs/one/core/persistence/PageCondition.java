...
public class PageCondition extends StringAndEqualsObject {
     ...
     * @param page
     */
    public PageCondition(PageBck page) {
        this.page = page;
    }
     ...
     * @param orderByClause
     */
    public PageCondition(PageBck page, String orderByClause) {
        this.page = page;
        this.orderByClause = orderByClause;
    }
     ...
     */
    public void setPage(final PageBck page) {
        this.page = page;
    }
