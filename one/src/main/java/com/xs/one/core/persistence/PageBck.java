 ...
 * @author linyl linyuliang.85@gmail.com
 */
public class PageBck extends StringAndEqualsObject {
     ...
     */
    public PageBck(final long begin, final long length) {
        this.begin = begin;
        this.length = length;
     ...
     * @param count 总记录数
     */
    public PageBck(final long begin, final long length, final long count) {
        this(begin, length);
        this.count = count;
    }
